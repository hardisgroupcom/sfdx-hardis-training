...
In **Commands > CI/CD (simple)**, click **Reset selected list of items to merge**.

![The sfdx-hardis Commands tree, where the recovery commands live](../../_assets/vscode/sidebar.png)
