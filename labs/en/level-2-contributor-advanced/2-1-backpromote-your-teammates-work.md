...
you resolve it in the VS Code merge editor, the same way Lab 2.7 has you resolve a Pull Request
...
- **It does not bring records.** Metadata only. If a teammate's story needed reference data, that
  data is not in your org, and no deployment will ever put it there. Lab 2.4 is about that exact
  problem
